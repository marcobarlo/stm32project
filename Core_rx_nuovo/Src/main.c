...
void portsStartup()             // pc4 pc5 usart, pa11 pa12 usart rts cts, pa0 bottone
{
	...
	GPIOE->MODER |= GPIO_MODER_MODER0_0 |GPIO_MODER_MODER1_0 | GPIO_MODER_MODER2_0;									//pin pe0 pe2 per rs en e rw
	GPIOE->ODR &= ~(2);		//pin di r not w a 0
